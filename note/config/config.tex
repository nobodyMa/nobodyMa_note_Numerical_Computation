...
\lstset{
    breaklines=true,
    language=Matlab,
    backgroundcolor=\color{gray!10},  % 10% 灰色背景
    showstringspaces=false,
    basicstyle=\footnotesize\ttfamily,  % 基本样式设为等宽正体
    commentstyle=\ttfamily\color{green!50!black}, % 注释使用正体+绿色
    keywordstyle=\color{blue},        % 关键字样式
    stringstyle=\color{purple},       % 字符串样式
    numbers=left,                     % 显示行号
    numbersep=-15pt,                  % 行号与代码间距
    numberstyle=\ttfamily\footnotesize\color{black}, % 行号正体
    aboveskip=-5pt,                   % 减小上方间距
    belowskip=-5pt,                   % 减小下方间距
    columns=fixed,                    % 固定字符宽度
    escapeinside={\%*}{*)},           % 定义转义分隔符
    literate=                         % 确保数字和注释符号使用正体
      {0}{{\ttfamily 0}}1
      {1}{{\ttfamily 1}}1
      {2}{{\ttfamily 2}}1
      {3}{{\ttfamily 3}}1
...
\newtheorem*{note}{\indent \textcolor{b1}{注}}
